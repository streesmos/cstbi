...
export function Charts() {
  return ( <div>
    <Container>
      <h4 className="text-9xl font-extrabold text-sky-600/15 -mb-20 text-center">{new Date().getFullYear()}</h4>
      <p className="mb-12 text-4xl text-center">К этому году <span className="text-orange-400">ЦСТБИ</span></p>
    </Container>
    <div className="grid  w-full max-w-md justify-center text-foreground md:grid-cols-2 [&>div]:relative [&>div]:flex [&>div]:h-[137px] [&>div]:w-[224px] [&>div]:items-center [&>div]:justify-center [&>div]:p-4">
      <div>
        <div className="absolute left-[-85px] top-[45px] z-10 text-sm font-medium">
          Контрактов
        </div>
        <svg
        ...
        <TooltipDemo
          ...
          payload={[
            {  value: 1538, fill: "hsl(var(--chart-1))" },
      ...
      <div className="items-end">
        ...
        <TooltipDemo
          ...
          hideLabel
          payload={[
            {  value: 3022, fill: "hsl(var(--chart-3))" },
          ]}
          indicator="dot"
          className="w-[8rem]"
        />
      ...
      <div>
      <div className="absolute left-[-60px] top-[0px] z-10 text-sm font-medium">
      Проведено сертифицированных испытаний
        </div>
        <TooltipDemo
         
          payload={[
            { value: 68, fill: "hsl(var(--chart-3))" },
          ]}
          className="w-[9rem]"
          indicator="line"
        />
        <svg
          ...
          fill="none"
          viewBox="0 0 75 175"
          className="absolute left-[30px] top-[38px] z-10 rotate-[120deg]"
        >
          <g clip-path="url(#abc)">
            <path
              fill="currentColor"
      ...
      <div className="!items-start !justify-start">
        ...
        Проверено и исследовано технических средств
        </div>
        <TooltipDemo
        
          hideLabel
          payload={[
            { value: 182422, fill: "hsl(var(--chart-1))" },
          ]}
          indicator="dot"
          className="w-[8rem]"
        />
            ...
            >
              <>
                ...
                >
                  ...
                  <span className="font-mono font-medium tabular-nums text-lg">
